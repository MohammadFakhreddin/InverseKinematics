...
namespace MFA
{
    ...
    void BlinnPhongPipeline::SetPushConstants(
    ...
    void BlinnPhongPipeline::CreatePipeline(Params const & params)
    {
        // Vertex shader
        auto cpuVertexShader = Importer::ShaderFromSPV(
            Path::Instance()->Get("engine/shaders/color_pipeline/BlinnPhongPipeline.vert.spv"),
        ...
        auto cpuFragmentShader = Importer::ShaderFromSPV(
            Path::Instance()->Get("engine/shaders/color_pipeline/BlinnPhongPipeline.frag.spv"),
    ...
    void BlinnPhongPipeline::CreateDescriptorSets()
    {
